...
import org.eclipse.m2m.qvt.oml.mapping.util.QvtOperationalMappingArgumentsContainer;
...
public class InternalTransformationExecutor {
	...
	private ExecutionDiagnostic doExecute(ModelExtent[] args, IContext context) {
		...
		//============================
		//FIXME: Remove this block added for Pivot-based Mapping
		  ...
		  mappingArgumentsContainer.setOperationalTransformation(fTransformation);
		//============================
